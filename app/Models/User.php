...
class User extends Authenticatable
{
    ...
    public function statuses() {
        ...
        return $this->hasMany('Friendface\Models\Status', 'user_id');
        
    }
    
    public function likes() {
        
        return $this->hasMany('Friendface\Models\Like', 'user_id');
        
    }
        
    public function friendsOfMine() {
        
        return $this->belongsToMany('Friendface\Models\User', 'friends', 'user_id', 'friend_id');
    
    }
    
    public function friendsOf() {
        
        return $this->belongsToMany('Friendface\Models\User', 'friends', 'friend_id', 'user_id');
